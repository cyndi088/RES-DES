...
if __name__ == '__main__':
    print('aes_test:assssssssdfasasasasa')
    aes_test = USE_AES("assssssssdfasasasasa")
    print(aes_test)
    a1 = aes_test.encrypt("测试")
    print(a1)
    b1 = aes_test.decodebytes(a1)
    print(b1)

    print('rsa_test:')
    rsa_test = USE_RSA()
    print(rsa_test)
    a2 = rsa_test.rsaEncrypt("测试加密")
    print(a2)
    b2 = rsa_test.rsaDecrypt(a2)
    print(b2)

    print('des_test:b"12345678", b"12345678"')
    des_test = USE_DES(b"12345678", b"12345678")
    print(des_test)
    a3 = des_test.encrypt("测试加密")
    print(a3)
    b3 = des_test.descrypt(a3)
    print(b3)

    print('des3_test:b"123456789qazxswe"')
    des3_test = USE_DES3(b"123456789qazxswe")
    print(des3_test)
    a4 = des3_test.encrypt("测试加密")
    print(a4)
    b4 = des3_test.decrypt(a4)
    print(b4)
